...
import { Mail, Lock, Eye, EyeOff, ArrowRight, ShieldCheck, Heart } from "lucide-react";
...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-[#FAF6F2] text-[#2B2730] flex flex-col justify-center items-center px-4 py-12 relative overflow-hidden">
      {/* Decorative Blur */}
      <div className="absolute -top-32 -left-32 w-80 h-80 rounded-full bg-[#DC8E90]/15 blur-3xl pointer-events-none" />
      <div className="absolute -bottom-32 -right-32 w-80 h-80 rounded-full bg-[#58545F]/10 blur-3xl pointer-events-none" />
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-xs text-[#58545F] mt-1 font-medium">
            Sign in to track orders, save custom pet proofs, and support animal rescues.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <label className="text-xs font-black uppercase tracking-wider text-[#58545F] block mb-1">Password</label>
            <div className="relative flex items-center">
          ...
          >
            <span>{status === "loading" ? "Signing In..." : "Sign In to Furever 🐾"}</span>
            <ArrowRight size={15} />
          </button>
        </form>
        ...
        <div className="mt-8 text-center text-xs text-[#58545F] font-medium">
          New to Furever?{" "}
          <Link to="/signup" className="text-[#DC8E90] font-black uppercase tracking-wider hover:underline">
            Create an account
          </Link>
        </div>
      </motion.div>
